**Designation of Open Game Content**: All the pages about *Dark
Dungeons* are Open Content. For the remaining pages such as the license
itself, user pages, and so on, standard copyright applies unless
otherwise
indicated.

**Designation of Product Identity**: Nothing in the pages about *Dark
Dungeons* is designated Product
Identity.
...
Dark Dungeons published 2010, no Copyright is asserted on the original
text found in this work.